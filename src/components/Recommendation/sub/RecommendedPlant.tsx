...
//interfaces
import IRecommendedPlant from "../../../models/interfaces/IRecommendedPlant";

export default function RecommendedPlant({
  plant,
  quiz,
  open,
}: IRecommendedPlant) {
    ...
    <>
      <div className="recommended-plant">
        ...
        <div
          ...
          onClick={(e) => open(e, backgroundImage, plant.botanicalName)}
        ></div>
      </div>
    </>
  );
